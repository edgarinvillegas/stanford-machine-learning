...
for i=1:m  
  ...
  Theta2_Delta += delta_l * a2';  %num_labels x 1    1 x hidden_layer_size
  Theta1_Delta += delta_hidden * a1';  %hidden_layer_size x 1   1 x input_layer_size 
end

%disp('Theta1_Delta size: '); size(Theta1_Delta)
%disp('Theta2_Delta size: '); size(Theta2_Delta)

Theta1_grad = Theta1_Delta ./ m;
Theta2_grad = Theta2_Delta ./ m;
